tyrano.plugin.kag.tag.camera = {
    ...
    start: function (pm) {
        var that = this, duration = pm.time + "ms";
        void 0 === this.kag.stat.current_camera[pm.layer] && (this.kag.stat.current_camera[pm.layer] = {
            x: "0",
            y: "0",
            scale: "1",
            rotate: "0"
        ...
        "0" == pm.from_x && "0" == pm.from_y && "1" == pm.from_zoom && "0" == pm.from_rotate || (this.kag.stat.current_camera[pm.layer] = {
        ...
        var a3d_define = {
            frames: {"0%": {trans: this.kag.stat.current_camera[pm.layer]}, "100%": {trans: to_camera}},
...
tyrano.plugin.kag.tag.reset_camera = {
    vital: [], pm: {time: 1e3, wait: "true", ease_type: "ease", layer: "layer_camera"}, start: function (pm) {
        var that = this;
        parseInt(pm.time) < 10 && (pm.time = 10);
        var duration = pm.time + "ms", flag_complete = !1;
        that.kag.stat.is_move_camera = !0;
        var a3d_define = {
            frames: {
                "0%": {trans: this.kag.stat.current_camera[pm.layer]},
                "100%": {trans: {x: "0px", y: "0px", scale: "1", rotate: "0deg"}}
            }, config: {duration: duration, state: "running", easing: pm.ease_type}, complete: function () {
                $("." + pm.layer).css({
                    "-animation-name": "",
                    "-animation-duration": "",
        ...
        "layer_camera" != pm.layer ? delete this.kag.stat.current_camera[pm.layer] : this.kag.stat.current_camera = {};
        "false" == pm.wait && that.kag.ftag.nextOrder();
        if ("layer_camera" == pm.layer) {
            $(".layer_camera").css("-webkit-transform-origin", "center center");
            $(".layer_camera").a3d(a3d_define);
...
tyrano.plugin.kag.tag.wait_camera = {
    start: function (pm) {
        1 == this.kag.stat.is_move_camera ? this.kag.stat.is_wait_camera = !0 : this.kag.ftag.nextOrder()
    }
};
tyrano.plugin.kag.tag.mask = {
    vital: [], pm: {time: 1e3, effect: "fadeIn", color: "0x000000", graphic: "", folder: ""}, start: function (pm) {
        var that = this;
        ...
        var sc_width = parseInt(that.kag.config.scWidth), sc_height = parseInt(that.kag.config.scHeight), behind = !1;
...
tyrano.plugin.kag.tag.mask_off = {
    vital: [], pm: {time: 1e3, effect: "fadeOut"}, start: function (pm) {
        var that = this, j_div = $(".layer_mask");
        "0" == pm.time && (pm.time = "1");
