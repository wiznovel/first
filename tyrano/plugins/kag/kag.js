tyrano.plugin.kag = {
    ...
    init_game: function () {
        ...
        j_message.css("background-color", $.convertColor(this.config.frameColor))
            ...
            .css("z-index", 100);
        j_message.l_visible;
        var j_message_inner = $("<div class='message_inner' id='message_inner'></div>");
        ...
        j_message.append(j_message_inner);
    ...
    `;
        ...
        let positionStyles = (fuki_chara.sippo === "top" || fuki_chara.sippo === "bottom")
            ? topBottomStyles
            : leftRightStyles;

        let finalStyles = `${baseStyles}\n${positionStyles}`;

        $("#tmp_style").html(finalStyles);
        ...
        if (bgImagePath) {
            ...
            img.onload = function () {
                let imgWidth = fuki_chara.bubble_width;
                let imgHeight = fuki_chara.bubble_height;
                ...
                $(".fuki_box").css({
                    ...
                    transform: `rotate(${fuki_chara.bubble_rotate}deg)`,
                });

                let width = parseInt(fuki_chara.text_width);
                let posTextTopValue = parseFloat(fuki_chara.posTextTop);
                let posTextLeftValue = parseFloat(fuki_chara.posTextLeft);

                $('.message_inner').css({
                    marginTop: `${posTextTopValue}px`,
                    marginLeft: `${posTextLeftValue}px`,
                    maxWidth: `${width}px`,
                    paddingLeft: '0',
                    paddingTop: '0',
                    textAlign: 'center'
